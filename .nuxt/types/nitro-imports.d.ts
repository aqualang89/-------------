declare global {
  ...
  const addHistory: typeof import('../../server/utils/store').addHistory
  const answerCallbackQuery: typeof import('../../server/utils/telegram').answerCallbackQuery
  ...
  const askAquariumAI: typeof import('../../server/utils/ai').askAquariumAI
  ...
  const getHistory: typeof import('../../server/utils/store').getHistory
  const getMethod: typeof import('../../node_modules/h3').getMethod
  const getMode: typeof import('../../server/utils/store').getMode
  ...
  const popManualReplies: typeof import('../../server/utils/store').popManualReplies
  const promisifyNodeListener: typeof import('../../node_modules/h3').promisifyNodeListener
  const proxyRequest: typeof import('../../node_modules/h3').proxyRequest
  const queueManualReplyForSite: typeof import('../../server/utils/store').queueManualReplyForSite
  const readBody: typeof import('../../node_modules/h3').readBody
  const readFormData: typeof import('../../node_modules/h3').readFormData
  const readMultipartFormData: typeof import('../../node_modules/h3').readMultipartFormData
  const readRawBody: typeof import('../../node_modules/h3').readRawBody
  const readValidatedBody: typeof import('../../node_modules/h3').readValidatedBody
  const removeInlineKeyboard: typeof import('../../server/utils/telegram').removeInlineKeyboard
  ...
  const sendOwnerCard: typeof import('../../server/utils/telegram').sendOwnerCard
  const sendOwnerText: typeof import('../../server/utils/telegram').sendOwnerText
  ...
  const setMode: typeof import('../../server/utils/store').setMode
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from 'C:/Users/Татьяна/Projects/--------------main/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from 'C:/Users/Татьяна/Projects/--------------main/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { askAquariumAI } from 'C:/Users/Татьяна/Projects/--------------main/server/utils/ai';
export { getMode, setMode, addHistory, getHistory, queueManualReplyForSite, popManualReplies } from 'C:/Users/Татьяна/Projects/--------------main/server/utils/store';
export { sendOwnerCard, sendOwnerText, answerCallbackQuery, removeInlineKeyboard } from 'C:/Users/Татьяна/Projects/--------------main/server/utils/telegram';