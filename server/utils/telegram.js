...
// Корни без \b (в JS \b работает только для ASCII — на кириллице ломается).
// False positive допустим: лучше лишний пуш чем пропущенный лид.
const USER_TRIGGERS = [
  { re: /телефон/i, label: 'телефон' },
  { re: /позвон/i, label: 'позвонить' },
  { re: /перезвон/i, label: 'перезвонить' },
  { re: /связаться|свяжитесь/i, label: 'связаться' },
  { re: /контакт/i, label: 'контакт' },
  { re: /купить|куплю/i, label: 'купить' },
  { re: /заказ|закаж/i, label: 'заказ' },
  { re: /бронир/i, label: 'бронь' },
  { re: /адрес/i, label: 'адрес' },
  { re: /менеджер/i, label: 'менеджер' },
  { re: /консультант/i, label: 'консультант' },
